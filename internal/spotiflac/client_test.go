...
func TestDownloadProgress(t *testing.T) {
	...
	client := spotiflac.NewClient(mockCli(t, responses), 10*time.Second, "tidal", "lossless", "", "", "", nil, "", nil)
...
func TestDownloadTimeout(t *testing.T) {
	...
	client := spotiflac.NewClient(mockCli(t, responses), 1*time.Nanosecond, "tidal", "lossless", "", "", "", nil, "", nil)
...
func TestDownloadCapturesOutputOnFailure(t *testing.T) {
	...
	client := spotiflac.NewClient(mockCli(t, responses), 5*time.Second, "tidal", "lossless", "", "", "", nil, "", nil)
